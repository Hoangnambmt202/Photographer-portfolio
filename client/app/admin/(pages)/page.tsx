...
import { 
  Users, Camera, Calendar, DollarSign, 
...
export default function Dashboard() {
  ...
  const photoStatus = [
    { label: 'Cần duyệt', count: 234, icon: Eye, color: 'text-yellow-600 bg-yellow-50' },
    { label: 'Cần gửi khách', count: 45, icon: Send, color: 'text-blue-600 bg-blue-50' },
    { label: 'Đã hoàn tất', count: 567, icon: CheckCircle, color: 'text-green-600 bg-green-50' },
  ];

  const albumStatus = [
    { title: 'Đám cưới Lan - Minh', progress: 85, status: 'Đang xử lý', date: '28/11/2024' },
    { title: 'Pre-wedding Thu - Nam', progress: 100, status: 'Hoàn tất', date: '25/11/2024' },
    { title: 'Chụp gia đình Nguyễn', progress: 60, status: 'Đang chỉnh sửa', date: '01/12/2024' },
    { title: 'Sự kiện công ty ABC', progress: 30, status: 'Mới bắt đầu', date: '05/12/2024' },
  ];

  const upcomingBookings = [
    { client: 'Trần Văn A', type: 'Đám cưới', time: '09:00', date: '30/11/2024', color: 'from-pink-500 to-rose-500' },
    { client: 'Nguyễn Thị B', type: 'Chân dung', time: '14:00', date: '30/11/2024', color: 'from-blue-500 to-cyan-500' },
    { client: 'Lê Văn C', type: 'Gia đình', time: '10:00', date: '01/12/2024', color: 'from-green-500 to-emerald-500' },
    { client: 'Phạm Thị D', type: 'Pre-wedding', time: '08:00', date: '02/12/2024', color: 'from-purple-500 to-indigo-500' },
  ];
            ...
            >
              <div className="p-6 relative">
                ...
                <div className="flex items-center text-sm">
                  <TrendingUp className={`w-4 h-4 mr-1 ${stat.trendUp ? 'text-green-600' : 'text-red-600'}`} />
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                      album.progress === 100 ? 'bg-green-100 text-green-700' :
                      album.progress >= 60 ? 'bg-blue-100 text-blue-700' :
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-semibold text-gray-900">{album.progress}%</span>
                    </div>
                    <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                      <motion.div
                        className={`h-full rounded-full ${
                          album.progress === 100 ? 'bg-linear-to-r from-green-500 to-emerald-500' :
                          album.progress >= 60 ? 'bg-linear-to-r from-blue-500 to-cyan-500' :
