        ...
        <div>
          <nav aria-label="Pagination" className="isolate inline-flex -space-x-px rounded-md">
            ...
            >
              ...
              <ChevronsLeftIcon aria-hidden="true" className="size-5" />
            </a>
            {/* Current: "z-10 text-white focus-visible:outline-2 focus-visible:outline-offset-2 bg-indigo-500 focus-visible:outline-indigo-500", Default: "inset-ring focus:outline-offset-0 text-gray-400 inset-ring-gray-700 hover:bg-white/5" */}
            <a
              href="#"
              aria-current="page"
            ...
            >
              ...
              <ChevronsRightIcon aria-hidden="true" className="size-5" />
            </a>
          </nav>
        </div>
      </div>
